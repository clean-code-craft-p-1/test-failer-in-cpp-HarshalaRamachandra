...
void TestgetColorMap()
{
    ...
    assert(ColorMap::getColorMap(4,4) == "25 | Violet   | Slate");
    assert(ColorMap::getColorMap(5,0) == "Incorrect pair number, majorColorIndex[5], minorColorIndex[0]");
    assert(ColorMap::getColorMap(5,1) == "Incorrect pair number, majorColorIndex[5], minorColorIndex[1]");
    assert(ColorMap::getColorMap(5,2) == "Incorrect pair number, majorColorIndex[5], minorColorIndex[2]");
    assert(ColorMap::getColorMap(5,3) == "Incorrect pair number, majorColorIndex[5], minorColorIndex[3]");
    assert(ColorMap::getColorMap(5,4) == "Incorrect pair number, majorColorIndex[5], minorColorIndex[4]");
    assert(ColorMap::getColorMap(5,5) == "Incorrect pair number, majorColorIndex[5], minorColorIndex[5]");
}
